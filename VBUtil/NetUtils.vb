...
Namespace Utils
    Namespace NetUtils
        ...
        Public Module Constants
            ...
            Public Const DEFAULT_AUTO_REDIRECT As Boolean = True
        End Module
        '默认保存cookie的模块
        ...
        Public Class NetStream
            ...
            Public Property AutoRedirect As Boolean '是否自动跳转重定向
            ...
            Public Shared Function parseCookie(ByVal header As String, ByVal defaultDomain As String) As Net.CookieCollection
                ...
                While i < Len(header)
                    ...
                    While i < Len(header) AndAlso header(i) <> ","c
                        ...
                        If i < Len(header) AndAlso header(i) <> ","c Then
                            i += 1
                            skipChar(header, i)
                            pvalue = parseCookieValue(header, i, pkey)
                        End If
                        skipChar(header, i)
                        arg.Add(pkey, pvalue)
                    End While
            ...
            Private Shared Function parseCookieValue(ByVal header As String, ByRef i As Integer, ByVal propertyName As String) As String
                ...
                ElseIf propertyName = "expires" Then
                    limitStr = ";="
                ElseIf propertyName = "httponly" Then
                    Return ""
                Else
                    limitStr = ";,"
                End If
            ...
            Public Sub HttpGet(ByVal url As String, Optional ByVal headerParam As Parameters = Nothing, Optional ByVal urlParam As Parameters = Nothing, Optional ByVal range As Integer = -1)
                ...
                Do
                    Try
                        ...
                        HTTP_Request.AllowAutoRedirect = AutoRedirect
                        'range
                        If range >= 0 Then
            ...
            Public Function ReadResponseString(ByVal Optional _encoding As Encoding = Nothing) As String
                If (_encoding Is Nothing) Then _encoding = Encoding.UTF8
                If Stream Is Nothing OrElse Stream.CanRead = False Then Return ""
                Return ReadToEnd(Stream, _encoding)
            End Function
        End Class
    End Namespace
End Namespace